...
grant select, insert, update, delete on public.project_calendars to authenticated, anon;
grant select, insert, update, delete on public.project_calendar_days to authenticated, anon;

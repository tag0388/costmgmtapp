...
export async function copyEnterpriseCalendarToProject(projectId: string, source: EnterpriseCalendar, calendarId: string, calendarName: string) {
  const copied = await createProjectCalendar({
    ...
    calendar_id: calendarId.trim(), calendar_name: calendarName.trim(),
    sunday_working: source.sunday_working, monday_working: source.monday_working, tuesday_working: source.tuesday_working,
    wednesday_working: source.wednesday_working, thursday_working: source.thursday_working, friday_working: source.friday_working, saturday_working: source.saturday_working,
    is_active: true,
  });

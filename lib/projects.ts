...
export type ProjectInput = { enterprise_id: string; project_code: string; name: string; status: ProjectStatus };
...
export function deleteAllProjectsForEnterprise(enterpriseId: string) {
